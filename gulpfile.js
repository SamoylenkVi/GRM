...
import {ttfToWoff, woffToWoff2} from "./gulp/tasks/fonts.js";
...
export { sprite }
const fonts = gulp.series(ttfToWoff, woffToWoff2);
const mainTasks = gulp.series(fonts, gulp.parallel(copy, html, scss, js, img, copyCss));
